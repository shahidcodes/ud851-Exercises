...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        String url = "https://shahidkamal.me";
        openWebPage(url);
    }
    ...
    private void openWebPage(String url){
        Intent openPageIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(url));
        if (openPageIntent.resolveActivity(getPackageManager()) != null){
