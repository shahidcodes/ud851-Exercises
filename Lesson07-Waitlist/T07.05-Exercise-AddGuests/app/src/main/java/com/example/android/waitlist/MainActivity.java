...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        if (TextUtils.isEmpty(name) || TextUtils.isEmpty(partySizeString)) return;
        ...
        try {
            ...
            partySizeInt = Integer.parseInt(partySizeString);
        }catch (Exception e){}
    ...
    private void addNewGuest ( String name, int partySize){
        ...
        mDb.insert(
                WaitlistContract.WaitlistEntry.TABLE_NAME, null, cv
        );
    }
